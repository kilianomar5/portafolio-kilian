    ...
    >
      ...
      <div className="section-container flex flex-col lg:flex-row items-center justify-between gap-10">
        <div className="flex flex-col max-w-xl space-y-6 text-center lg:text-left">
          ...
          >
            Hago desarrollo web de páginas, me gusta montar ordenadores y jugar videojuegos.
          </motion.p>
          ...
          >
            <motion.div className="flex flex-row items-center gap-4">
              ...
              >
                <a href="#contacto" aria-label="Go to contact section">
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="space-y-2 font-mono text-sm">
                <div className="text-gray-500">{"// Informático & Desarrollador Web"}</div>
                <div>
                ...
                >
                  ...
                  <span className="text-gray-500">:</span>{" "}
                  <span className="text-green-600">'Kilian Omar'</span>
                  <span className="text-gray-500">,</span>
                </motion.div>
                ...
                >
                  <span className="text-purple-600">habilidades</span>
                  <span className="text-gray-500">:</span>{" "}
                  <span className="text-orange-500">[</span>
                ...
                >
                  <span className="text-purple-600">enfoques</span>
                  <span className="text-gray-500">:</span>{" "}
                  <span className="text-orange-500">[</span>
                  <span className="text-green-600">'Música'</span>
                  <span className="text-gray-500">,</span>{" "}
                  <span className="text-green-600">'VideoJuegos'</span>
                  <span className="text-orange-500">]</span>
                  <span className="text-gray-500">,</span>
                </motion.div>
                ...
                >
                  <span className="text-purple-600">aprendizaje</span>
                  <span className="text-gray-500">:</span>{" "}
                  <span className="text-green-600">'Siempre'</span>
                </motion.div>
