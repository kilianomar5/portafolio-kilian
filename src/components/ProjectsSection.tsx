...
const ProjectsSection = () => {
  ...
  return (
    <section id="proyectos" className="pt-14 bg-background/50">
      <div className="section-container">
        <h2 className="section-heading">Proyectos</h2>
        <p className="text-muted-foreground max-w-2xl mb-12">
          Aquí hay algunos de los proyectos en los que he trabajado, mostrando mis habilidades en
          varias tecnologías y dominios de problemas.
        </p>
