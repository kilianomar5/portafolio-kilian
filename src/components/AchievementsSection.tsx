...
const AchievementsSection = () => {
  ...
  return (
    <section id="logros" className="pt-14 bg-background/50">
      <div className="section-container">
        ...
        >
          <h2 className="section-heading">Logros</h2>
          <p className="text-muted-foreground max-w-2xl mb-12">
            Una colección de mis logros profesionales, premios y
            certificaciones obtenidas a lo largo de mi trayectoria.
          </p>
        </motion.div>
        ...
        <div className="flex justify-between mb-6 space-x-2">
          <div className="flex items-center text-muted-foreground">
            ...
            <span className="text-sm hidden md:inline">Arrastra para explorar</span>
            <span className="text-sm md:hidden">Desliza para explorar</span>
          </div>
