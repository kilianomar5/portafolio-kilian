...
const ThemeSwitcher = () => {
  ...
  // Tipamos 'themes' con el mismo tipo 'Theme'
  const themes: { name: "blue" | "dark" | "purple"; icon: JSX.Element; label: string }[] = [
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="space-y-1">
        {themes.map((t) => (
          <DropdownMenuItem
            key={t.name}
            onClick={() => setTheme(t.name)} // ✅ Ya no necesitamos 'as any'
